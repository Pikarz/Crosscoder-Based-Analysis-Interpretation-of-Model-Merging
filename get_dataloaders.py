...
def get_pokemon_dataloader(pokemon_dataset, batch_size, training_size, validation_size, test_size):
    ...
    train_set, val_set, test_set = torch.utils.data.random_split(pokemon_dataset, [training_size, validation_size, test_size])
...
if __name__ == '__main__':
    ...
    pokemon_dataloader = get_pokemon_dataloader(pokemon_dataset, batch_size, training_size, validation_size, test_size)